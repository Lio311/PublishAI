          ...
          <div className="md:col-span-3 p-8 space-y-8">
            ...
            {activeTab === "notifications" && (
              <div>
                ...
                <p className="text-slate-500">
                  {locale === "he" ? "הגדרות התראות יופיעו כאן." : "Notification settings will appear here."}
                </p>
              </div>
            )}
            ...
            {activeTab === "privacy" && (
              <div>
                ...
                <p className="text-slate-500">
                  {locale === "he" ? "הגדרות פרטיות יופיעו כאן." : "Privacy settings will appear here."}
                </p>
              </div>
            )}
            ...
            {activeTab === "api_keys" && (
              <div>
                ...
                <p className="text-slate-500">
                  {locale === "he" ? "ניהול מפתחות API יופיע כאן." : "API key management will appear here."}
                </p>
              </div>
            )}
          </div>
