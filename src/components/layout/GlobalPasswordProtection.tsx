                    ...
                    <div className="backdrop-blur-2xl bg-white border border-slate-200 rounded-3xl p-10 shadow-xl overflow-hidden relative">
                        ...
                        <div className="relative z-10 flex flex-col items-center">
                            ...
                            <div className="w-full flex flex-col items-center gap-4">
                                <button
                                    onClick={() => signIn('credentials', { username: 'admin', password: 'password', callbackUrl: '/' })}
                                    className="flex w-full items-center justify-center gap-3 px-6 py-4 rounded-xl font-medium text-white bg-slate-900 border-2 border-slate-900 hover:bg-slate-800 transition-all shadow-sm active:scale-[0.98]"
                                >
                                    התחבר למערכת (משתמש הדגמה)
                                </button>
                            </div>
                        </div>
                    </div>
