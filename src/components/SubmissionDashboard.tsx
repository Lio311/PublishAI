...
export const DEFAULT_SUBMISSIONS: SubmissionItem[] = [
  {
    id: "sub-101",
    paperId: 1,
    ...
    confirmationId: "NBT-2026-08942",
    remotePostUrl: "https://nature.example.org/submissions/NBT-2026-08942",
    articleType: "Research Article",
    authors: ["Dr. Eleanor Vance", "Prof. Marcus Brody", "AI Co-Author"],
    abstract: "We present a multi-omics deep generative model that resolves variant pathogenicity across 12 distinct cancer cohorts with unprecedented cross-modality alignment.",
    attemptCount: 1,
    maxAttempts: 3,
    commentsCount: 4,
  ...
  },
  {
    ...
    confirmationId: "CELL-SYS-26-1180",
    remotePostUrl: "https://cell.example.org/track/CELL-SYS-26-1180",
    articleType: "Original Article",
    authors: ["Dr. Eleanor Vance", "Dr. Chen Wei"],
    abstract: "Hyperbolic geometric transformers yield conformal mappings of tertiary structures into negative curvature manifolds, accelerating alignment speeds by 40x.",
    attemptCount: 1,
    maxAttempts: 3,
    commentsCount: 0,
  ...
  },
  {
    ...
    platform: "OJS 3 (Open Journal Systems)",
    status: "submitted",
    publishMode: "publish",
    submittedAt: "2026-09-16T11:00:00Z",
    updatedAt: "2026-09-16T11:05:00Z",
    confirmationId: "PCOMPBIOL-D-26-00431",
    remotePostUrl: "https://journals.plos.org/ploscompbiol/author-area",
    articleType: "Methods",
    authors: ["Dr. Eleanor Vance", "PublishAI Swarm Team"],
    abstract: "Systematic reviews frequently experience reviewer exhaustion. We introduce a calibrated multi-agent debate architecture with cross-verification heuristics.",
    attemptCount: 1,
    maxAttempts: 3,
    commentsCount: 0,
    unresolvedCommentsCount: 0,
  },
  {
    ...
    platform: "Direct REST API",
    status: "failed",
    publishMode: "publish",
    submittedAt: "2026-09-17T09:12:00Z",
    updatedAt: "2026-09-17T09:14:00Z",
    confirmationId: "PENDING-RETRY",
    articleType: "Regular Paper",
    authors: ["Dr. Eleanor Vance"],
    abstract: "Single-cell transcriptomics reveals state transitions during human embryonic stem cell differentiation towards functional ventricular myocytes.",
    attemptCount: 3,
    maxAttempts: 3,
    errorLog: "HTTP 504 Gateway Timeout: Target journal endpoint failed to acknowledge PDF package upload after 120s. SSL handshake succeeded.",
    commentsCount: 0,
    unresolvedCommentsCount: 0,
  },
  {
    id: "sub-105",
    paperId: 5,
    title: "Graph-Guided Molecular Discovery for Non-Small Cell Lung Carcinoma",
    journalName: "Bioinformatics (Oxford)",
    platform: "ScholarOne",
    status: "preparing",
    publishMode: "draft",
    submittedAt: "2026-09-17T22:30:00Z",
    updatedAt: "2026-09-17T22:30:00Z",
    articleType: "Application Note",
    authors: ["Dr. Eleanor Vance", "Dr. Sarah Lin"],
    abstract: "Integrating heterogeneous knowledge graphs with message-passing neural networks for ligand-receptor docking prediction.",
    attemptCount: 0,
    maxAttempts: 3,
    commentsCount: 0,
    unresolvedCommentsCount: 0,
...
export default function SubmissionDashboard({
  submissions: initialSubmissions = DEFAULT_SUBMISSIONS,
  onSelectSubmission,
  onNavigateToReviews,
  onNewSubmission,
  onRetrySubmission,
    ...
    <div className="w-full space-y-6 font-sans" dir={isHe ? "rtl" : "ltr"}>
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 bg-white/80 backdrop-blur-xl border border-slate-200/80 rounded-2xl p-6 shadow-xs">
        ...
        <div className="flex items-center gap-3">
          <button
            onClick={() => {
              setSubmissionsList([...DEFAULT_SUBMISSIONS]);
            }}
