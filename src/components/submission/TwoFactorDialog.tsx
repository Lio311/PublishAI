        ...
        <form onSubmit={handleSubmit} className="p-6">
          ...
          <div className="space-y-4">
            ...
            <button
              ...
              className="w-full py-2.5 bg-gradient-to-r from-blue-900 via-blue-700 to-sky-400 text-white font-medium rounded-lg hover:from-blue-800 hover:via-blue-600 hover:to-sky-300 disabled:opacity-50 flex items-center justify-center gap-2 transition-colors"
            >
