...
export const submissions = pgTable("submissions", {
  ...
  fundingDeclaration: boolean("funding_declaration").default(false),
  aiUsageDeclaration: boolean("ai_usage_declaration").default(false),
  depositInArchive: boolean("deposit_in_archive").default(false),
  keyFindings: text("key_findings"),
  meshTerms: jsonb("mesh_terms"),
  dataAvailableStatement: text("data_available_statement"),
  conflictOfInterestStatement: text("conflict_of_interest_statement"),
  duplicateMaterialStatement: text("duplicate_material_statement"),
