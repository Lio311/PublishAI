...
- Name: auth.spec.ts >> Authentication Flows >> should allow entering credentials into login form
...
Call log:
  - waiting for locator('input[type="email"], input[name="email"], #email-address')
...
- generic [active] [ref=e1]:
  - generic [ref=e6]:
    - img "PublishAI Logo" [ref=e8]
    - paragraph [ref=e9]: התחברות לחשבון
