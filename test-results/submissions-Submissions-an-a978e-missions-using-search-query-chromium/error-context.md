...
- Name: submissions.spec.ts >> Submissions and Review Rebuttal Flows >> should filter submissions using search query
- Location: e2e/submissions.spec.ts:88:7
...
Locator: getByPlaceholder(/Search title, journal, ID/i)
Expected: visible
Timeout: 10000ms
Error: element(s) not found

Call log:
  - Expect "toBeVisible" getByPlaceholder(/Search title, journal, ID/i) with timeout 10000ms
  - waiting for getByPlaceholder(/Search title, journal, ID/i)
